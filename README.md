...
A lightweight, framed, sequenced, and flow-controlled datagram protocol for use over any reliable byte-stream transport (UART, USB CDC, TCP socket, named pipe). Designed for embedded systems communicating with a host process.
